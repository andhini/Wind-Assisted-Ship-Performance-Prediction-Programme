...
Please refer to the manual of the program in a pdf file (will be provided later). Currently, master branch is the most updated version. The main code is <br />
VPP_WAShip.py, <br />
supported by the following ship files: <br />
Aframax.py,  <br />
HM_ship.py,  <br />
...
The calling arrangement of the programme in VPP_WAShip.py can be generally explained by the following flowchart. <br />
...
Inquiries and request can be addressed to my email in Research Repository. Enjoy the WASp PPP!